...
export default function Nav() {
  return (
    <>
      <div className="lg:h-min-screen hidden h-24 w-full bg-slate-100 lg:block lg:w-24"></div>
      <nav className="top-0 left-0 z-30 flex w-full justify-between bg-slate-800 pr-8 lg:fixed lg:min-h-screen lg:w-24 lg:flex-col lg:rounded-r-3xl lg:pb-8">
